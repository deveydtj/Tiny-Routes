...
- [x] Position nodes using coordinates from the JSON if available.
- [x] If coordinates are missing, place nodes using a simple fallback layout.
...
- [x] The app does not crash when node coordinates are missing.
